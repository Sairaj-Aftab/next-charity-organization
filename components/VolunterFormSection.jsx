...
import img from "@/assets/images/smiling-casual-woman-dressed-volunteer-t-shirt-with-badge.jpg";

function VolunterFormSection() {
  return (
    <section
      className="volunteer-section section-padding"
      id="volunter-section"
    >
...
export default VolunterFormSection;
